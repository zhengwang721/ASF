...
#define aplcMaxPairIndicationWaitTime_us   1200000UL /*(aplcMaxPairIndicationWaitTime * 1000000UL)*/
...
#define aplcMinIntPipeUnsafeTxWindowTime_us (aplcMinIntPipeUnsafeTxWindowTime * 1000UL)
...
typedef enum zid_attribute_tag
{
    ...
    /** The aplHIDParserVersion attribute specifies the version of the core HID
        specification. */
    aplHIDParserVersion                 = 0xe0,
    /** The aplHIDDeviceSubclass attribute specifies the HID subclass code of
        the HID class device. */
    aplHIDDeviceSubclass,
    /** The aplHIDProtocolCode attribute specifies the HID protocol code of the
    ...
    /** The aplHIDVendorId attribute specifies the USB-IF assigned identifier
        corresponding to the vendor of the device. */
    aplHIDVendorId,
    /** The aplHIDProductId attribute specifies a manufacturer assigned product
    ...
    aplHIDNumEndpoints,
    /** The aplHIDPollInterval attribute specifies the polling interval for all
        endpoint data transfers. */
    aplHIDPollInterval,
    /** The aplHIDNumStdDescComps attribute specifies the number of RF4CE ZID
        profile defined standard descriptors supported by the device. */
    aplHIDNumStdDescComps,
    /** The aplHIDStdDescriptorList attribute is of length equal to the value
        of the aplHIDNumStdDescComps attribute and shall specify the list of
        standard RF4CE ZID profile defined descriptors supported by the device. */
    aplHIDStdDescCompsList,
    aplHIDNumNullReports,
    /** The aplHIDNumDescriptors attribute specifies the number of non standard
...
typedef struct hid_attr_tag
{
    ...
    uint8_t DescriptorSpec[aplcMaxNonStdDescCompsPerHID][aplcMaxNonStdDescCompSize+4];
#ifdef ZID_ADAPTOR
...
typedef void (*zid_get_report_indication_cb_t)(uint8_t PairingRef, zid_report_types_t zid_report_type,
...
typedef void (*zid_get_attribute_confirm_cb_t)(nwk_enum_t Status, uint8_t PairingRef, zid_attribute_t ZIDAttribute,
                                               uint8_t ZIDAttributeIndex, uint8_t AttributeSize, uint8_t *ZIDAttributeValue);

typedef void (*zid_set_attribute_confirm_cb_t)(nwk_enum_t Status, uint8_t PairingRef,
...
typedef void (*zid_report_data_indication_cb_t)(uint8_t PairingRef, uint8_t num_report_records,
                                                zid_report_data_record_t *zid_report_data_record_ptr, uint8_t RxLinkQuality, uint8_t RxFlags);

#ifdef VENDOR_DATA
typedef void (*vendor_data_ind_cb_t)(uint8_t PairingRef, uint16_t VendorId, uint8_t nsduLength,
...
//bool get_attribute_properties(uint8_t PairingRef, zid_attribute_t attribute_id, uint8_t index, zid_data_types_t *type, uint8_t *length, uint8_t **value);
...
bool zid_report_data_request(uint8_t PairingRef, uint8_t numReportRecords, zid_report_data_record_t *reportRecord, uint8_t TxOptions
#ifdef RF4CE_CALLBACK_PARAM
...
#ifdef ZID_ADAPTOR
bool zid_set_report_request(uint8_t PairingRef, uint8_t payloadlength, uint8_t *payload,uint8_t TxOptions
#ifdef RF4CE_CALLBACK_PARAM
                             , FUNC_PTR confirm_cb
#endif
                            );
...
bool zid_get_report_data_request(uint8_t PairingRef,zid_report_types_t zid_report_type,zid_report_desc_t zid_report_desc, \
  uint8_t TxOptions
#ifdef RF4CE_CALLBACK_PARAM
...
#if (ZID_SET == 1)
bool zid_set_attribute_request(uint8_t PairingRef, zid_attribute_t ZIDAttribute, uint8_t ZIDAttributeIndex, uint8_t *ZIDAttributeValue
#ifdef RF4CE_CALLBACK_PARAM
...
#if (ZID_GET == 1)
bool zid_get_attribute_request(bool OTA, uint8_t PairingRef, zid_attribute_t ZIDAttribute, uint8_t ZIDAttributeIndex
#ifdef RF4CE_CALLBACK_PARAM
                               , FUNC_PTR zid_get_attribute_confirm
#endif
                              );
//void zid_get_attribute_confirm(nwk_enum_t Status, uint8_t PairingRef, zid_attribute_t ZIDAttribute, uint8_t ZIDAttributeIndex, uint8_t *ZIDAttributeValue);
#endif
 ...
 */
void zid_data_indication(uint8_t PairingRef, uint16_t VendorId,uint8_t nsduLength, uint8_t *nsdu,

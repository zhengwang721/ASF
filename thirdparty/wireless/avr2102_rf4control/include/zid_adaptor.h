 ...
 *
 * $Id: zid_adaptor.h 34116 2013-02-15 12:34:33Z agasthian.s $
 *
...
void connect_data_indication(gdp_msg_struct_t *gdpmsg,uint8_t RxLinkQuality, uint8_t RxFlags);
bool send_get_attributes_request(uint8_t PairingRef, zid_attribute_t ZIDAttribute);

gdp_response_code_t handle_incoming_push_attribute(gdp_msg_struct_t *gdpmsg);


//bool send_attributes(uint8_t PairingRef, uint8_t num_attributes, uint8_t *attribute_list, zid_cmd_code_t cmd_code);
//void set_attribute_value(uint8_t PairingRef, zid_attribute_t attribute_id, uint8_t *value);
bool set_attribute_value(uint8_t PairingRef, zid_attribute_t attribute_id, uint8_t *value);
/*
...
//void connect_data_indication(uint8_t PairingRef, uint8_t nsduLength, uint8_t *nsdu,
...
#endif  /* #if (((defined ZID_PROFILE) && (defined ZID_ADAPTOR)) || (defined DOXYGEN)) */

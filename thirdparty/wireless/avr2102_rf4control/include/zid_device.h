 ...
 *
 * $Id: zid_device.h 33965 2013-01-20 06:28:21Z agasthian.s $
 *
...
//void zid_configuration_handshake_response_timeout_cb(void *callback_parameter);
...
#endif  /* #if (((defined ZID_PROFILE) && (defined ZID_DEVICE)) || (defined DOXYGEN)) */

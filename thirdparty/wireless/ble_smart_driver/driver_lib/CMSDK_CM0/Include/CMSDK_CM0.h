...
/* ToDo: use this Cortex interrupt numbers if your device is a CORTEX-M0 device                   */
  ...
  SysTick_IRQn                  = -1,       /*!< 15 Cortex-M0 System Tick Interrupt               */
	...
	MUX20_IRQn,
	BLE_CORE_RESET_IRQn,
	BLE_LP_CORE_RESET_IRQn,
	PORT0_COMB_IRQn,
	PORT1_COMB_IRQn,
	PORT2_COMB_IRQn,
	TIMER0_IRQn,
	AON_SLEEP_TIMER_IRQn,
	BLE_OSC_EN_IRQn,
	BLE_WAKEUP_LP_IRQn,
	RXTX_SEQ_SLEEP_IRQn,
	BLE_CORE_IRQn
...
/* ToDo: use this Cortex interrupt numbers if your device is a CORTEX-M0 device                   */
  ...
  SPIRX0_IRQn                   = 4,       /*!< UART 2 RX Interrupt                               */
  SPITX0_IRQn                   = 5,       /*!< UART 2 TX Interrupt                               */
  DMA_IRQn                 			= 6,       /*!< External Combined Interrupt                       */
  PORT0_ALL_IRQn                = 7,       /*!< Port 1 combined Interrupt                         */
  PORT1_ALL_IRQn                = 8,       /*!< Port 1 combined Interrupt                         */
  TIMER0_IRQn                   = 9,       /*!< TIMER 0 Interrupt                                 */
  DUALTIMER_IRQn                = 10,      /*!< Dual Timer Interrupt                              */
  SPIRX1_IRQn                   = 11,      /*!< SPI 1 RX Interrupt                                */
  SPITX1_IRQn                   = 12,      /*!< SPI 1 TX Interrupt                                */
  I2CRX0_IRQn                   = 13,      /*!< I2C 0 RX Interrupt                                */
  I2CTX0_IRQn                   = 14,      /*!< I2C 0 TX Interrupt                                */
  AVAILABLE_IRQn              	= 15,      /*!< PL230 DMA Done + Error Interrupt                  */
  PORT0_0_IRQn                  = 16,      /*!< All P0 I/O pins can be used as interrupt source.  */
  PORT0_1_IRQn                  = 17,      /*!< There are 16 pins in total                        */
  PORT0_2_IRQn                  = 18,
  PORT0_3_IRQn                  = 19,
  BLE_LP_RESET_IRQn             = 20,
  BLE_CORE_RESET_IRQn           = 21,
  CALIBRATION_DONE_IRQn         = 22,
  SECURITY_IRQn                 = 23,
  BLE_FE_IRQn                  	= 24,
  SXPLL_NEED_RESET_IRQn         = 25,
  EXT_COMB_IRQn                 = 26,  
  AON_SLEEP_TIMER_IRQn          = 27,
  BLE_OSC_EN_IRQn               = 28,
  BLE_WAKEUP_LP_IRQn            = 29,
  RXTX_SEQ_SLEEP_IRQn           = 30,
  BLE_CORE_IRQn                 = 31,
} IRQn_Type;
...
#define CMSDK_DUALTIMER_BASE    (CMSDK_APB_BASE + 0x1000UL)
#define CMSDK_DUALTIMER_1_BASE  (CMSDK_DUALTIMER_BASE)
#define CMSDK_NMI_DMA_BASE    	(CMSDK_APB_BASE + 0x2000UL)
#define CMSDK_I2C0_BASE    		(CMSDK_APB_BASE + 0x3000UL)
#define CMSDK_I2C1_BASE   	 	(CMSDK_APB_BASE + 0x3400UL)
#define CMSDK_UART0_BASE        (CMSDK_APB_BASE + 0x4000UL)
#define CMSDK_UART1_BASE        (CMSDK_APB_BASE + 0x5000UL)
#define CMSDK_SPI0_BASE   	    (CMSDK_APB_BASE + 0x6000UL)
#define CMSDK_SPI1_BASE   	    (CMSDK_APB_BASE + 0x7000UL)
#define CMSDK_WATCHDOG0_BASE    (CMSDK_APB_BASE + 0x8000UL)
#define CMSDK_WATCHDOG1_BASE    (CMSDK_APB_BASE + 0x9000UL)

/* AHB peripherals                                                           */
#define CMSDK_GPIO0_BASE        (CMSDK_AHB_BASE + 0x0000UL)
#define CMSDK_GPIO1_BASE        (CMSDK_AHB_BASE + 0x1000UL)
#define CMSDK_SPI_FLASH_BASE    (CMSDK_AHB_BASE + 0x2000UL)
#define CMSDK_GPIO2_BASE        (CMSDK_AHB_BASE + 0x3000UL)
#define CMSDK_SYSCTRL_BASE      (CMSDK_AHB_BASE + 0x4000UL)
...
#define CMSDK_WATCHDOG0          ((CMSDK_WATCHDOG_TypeDef  *) CMSDK_WATCHDOG0_BASE   )
#define CMSDK_WATCHDOG1          ((CMSDK_WATCHDOG_TypeDef  *) CMSDK_WATCHDOG1_BASE   )

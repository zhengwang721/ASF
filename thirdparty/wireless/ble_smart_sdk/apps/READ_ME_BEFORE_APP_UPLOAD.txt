...
"C:\Program Files (x86)\Atmel\Studio\7.0\packs\atmel\SAMB11_DFP\1.0.90\tools\samb_makeimage.bat" "C:\Program Files (x86)\Atmel\Studio\7.0\packs\atmel\SAMB11_DFP\1.0.90\patches" "$(OutputDirectory)\$(OutputFileName).bin"  app_entry

2. Add below line in Project property -> Tool -> External programming tool
"C:\Program Files (x86)\Atmel\Studio\7.0\packs\atmel\SAMB11_DFP\1.0.90\tools\SambFlashTool.exe" write -i "$(OutputDirectory)\$(OutputFileName).img" -n $(avrtoolserialnumber) -c $(avrtoolinterfaceclock) -p $(avrdeviceexpectedsignature)

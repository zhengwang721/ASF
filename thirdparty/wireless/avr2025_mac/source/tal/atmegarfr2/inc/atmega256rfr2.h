 ...
 *
 * $Id: atmega256rfr2.h 30481 2012-01-27 12:36:10Z sschneid $
 *
...
/** Access parameters for sub-register MAF_0_AMI_EN in register @ref RG_IRQ_MASK1 */
#define SR_MAF_0_AMI_EN                 0xBE, 0x02, 1
/** Access parameters for sub-register MAF_1_AMI_EN in register @ref RG_IRQ_MASK1 */
#define SR_MAF_1_AMI_EN                 0xBE, 0x04, 2
/** Access parameters for sub-register MAF_2_AMI_EN in register @ref RG_IRQ_MASK1 */
#define SR_MAF_2_AMI_EN                 0xBE, 0x08, 3
/** Access parameters for sub-register MAF_3_AMI_EN in register @ref RG_IRQ_MASK1 */
...
/** Access parameters for sub-register AACK_0_I_AM_COORD in register @ref RG_MAFCR1 */
...
/** Access parameters for sub-register AACK_1_I_AM_COORD in register @ref RG_MAFCR1 */
...
/** Access parameters for sub-register AACK_2_I_AM_COORD in register @ref RG_MAFCR1 */
...
/** Access parameters for sub-register AACK_3_I_AM_COORD in register @ref RG_MAFCR1 */
...
/** Constant AES_COMPLETED for sub-register @ref SR_AES_DONE in register AES_STATUS */
#define AES_COMPLETED                   (1)
/** Constant AES_NOT_COMPLETED for sub-register @ref SR_AES_DONE in register AES_STATUS */
...
/** Constant CCA_NOT_COMPLETED for sub-register @ref SR_CCA_DONE in register TRX_STATUS */
...
/** Constant RATE_1_MBPS for sub-register @ref SR_OQPSK_DATA_RATE in register TRX_CTRL_2 */
#define RATE_1_MBPS                     (2)
/** Constant RATE_250_KBPS for sub-register @ref SR_OQPSK_DATA_RATE in register TRX_CTRL_2 */
#define RATE_250_KBPS                   (0)
/** Constant RATE_2_MBPS for sub-register @ref SR_OQPSK_DATA_RATE in register TRX_CTRL_2 */
#define RATE_2_MBPS                     (3)
/** Constant RATE_500_KBPS for sub-register @ref SR_OQPSK_DATA_RATE in register TRX_CTRL_2 */
...
/** Access parameters for sub-register CCA_ED_DONE_EN in register @ref RG_IRQ_MASK */
...
/** Constant BATMON_HIGH_RANGE for sub-register @ref SR_BATMON_HR in register BATMON */
#define BATMON_HIGH_RANGE               (1)
/** Constant BATMON_LOW_RANGE for sub-register @ref SR_BATMON_HR in register BATMON */
...
/** Constant BATMON_ABOVE_THRES for sub-register @ref SR_BATMON_OK in register BATMON */
#define BATMON_ABOVE_THRES              (1)
/** Constant BATMON_BELOW_THRES for sub-register @ref SR_BATMON_OK in register BATMON */
...
/** Constant ATMEGARFR2_PART_NUM for sub-register @ref SR_PART_NUM in register PART_NUM */
...
/** Constant SLOTTED_OPERATION_DISABLE for sub-register @ref SR_SLOTTED_OPERATION in register XAH_CTRL_0 */
#define SLOTTED_OPERATION_DISABLE       (0)
/** Constant SLOTTED_OPERATION_EnABLE for sub-register @ref SR_SLOTTED_OPERATION in register XAH_CTRL_0 */
...
/** Constant PD_ACK_BIT_SET_DISABLE for sub-register @ref SR_AACK_SET_PD in register CSMA_SEED_1 */
#define PD_ACK_BIT_SET_DISABLE          (0)
/** Constant PD_ACK_BIT_SET_ENABLE for sub-register @ref SR_AACK_SET_PD in register CSMA_SEED_1 */
...
/** Constant FRAME_VERSION_0 for sub-register @ref SR_AACK_FVN_MODE in register CSMA_SEED_1 */
